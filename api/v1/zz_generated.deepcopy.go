...
func (in *KustomizationStatus) DeepCopyInto(out *KustomizationStatus) {
	*out = *in
	...
	if in.QueueMetadata != nil {
		in, out := &in.QueueMetadata, &out.QueueMetadata
		*out = new(QueueMetadata)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *QueueMetadata) DeepCopyInto(out *QueueMetadata) {
	*out = *in
	if in.QueuedAt != nil {
	...
	if in.EstimatedProcessingTime != nil {
		in, out := &in.EstimatedProcessingTime, &out.EstimatedProcessingTime
		*out = (*in).DeepCopy()
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new QueueMetadata.
func (in *QueueMetadata) DeepCopy() *QueueMetadata {
	if in == nil {
		return nil
	}
	out := new(QueueMetadata)
